...
def parse_html(html):
    ...
    # find each tr (row) and its siblings
...
def write_to_file(content):
    ...
    '''
    # 一开始这里用的是 with open("result.txt",'a',encoding="utf-8") ，但是有warning，但是这里要 import codecs 然后用codecs.open 去打开并且写入中文
    # 并且code有中文所以一开始要加上uft-8
...
def get_page_nums():
    ...
    while True:
        ...
        soup = BeautifulSoup(html, 'lxml')
        # 这里  soup.body.text.strip() 应该 == "系统繁忙"
